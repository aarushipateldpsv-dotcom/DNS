...
Simulate DNS protocol
Demonstrate a Man-In-The-Middle attack to poison DNS reponses from the Resolver to the User, this is called DNS poisoning.
Demonstrate some mitigations.
Dependencies
